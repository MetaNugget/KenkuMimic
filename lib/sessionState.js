...
function reserveSession(guildId, { startedBy, channelId, textChannelId }) {
  ...
  sessions.set(guildId, {
    ...
    idleTimer: null, // set by mimic.js's idle-watch interval; cleared by whatever ends the session
    lastAudioAt: null, // stamped by mimic.js on every PCM chunk; read by the idle-watch interval above
  });
}
